    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_profile_url', models.URLField(blank=True, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journalists', models.ManyToManyField(related_name='articles', to='core.journalist')),
                ('categories', models.ManyToManyField(related_name='pages', to='core.newspagecategory')),
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages', to='core.newssource')),
            ],
        ),
        migrations.AddField(
